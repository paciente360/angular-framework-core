...
(function () {
    ...
    module.provider('fwFileLoad', fwFileLoadProvider);
    ...
    module.factory('Backbone', BackboneFactory);
    BackboneFactory.$inject = ['$window'];
    function BackboneFactory($window) {
        return $window.Backbone;
    }

    module.factory('Backgrid', BackgridFactory);
    ...
    module.service('fwAuthService', fwAuthService);
    ...
    module.service('fwChartService', fwChartService);
    ...
    module.service('fwErrorService', fwErrorService);
    ...
    module.service('fwModalService', fwModalService);
    ...
    module.service('utilsComparatorService', utilsComparatorService);
    ...
    module.service('utilsDateTimeService', utilsDateTimeService);
    ...
    module.service('utilsObjectService', utilsObjectService);
    ...
    module.service('utilsPrintService', utilsPrintService);
    ...
    module.service('utilsStringService', utilsStringService);
    ...
    module.directive('crudForm', crudForm);
    ...
    module.directive('crudList', crudList);
    ...
    module.directive('crudTabList', crudTabList);
    ...
    module.directive('fwAutoCompleteTable', fwAutoCompleteTable);
    ...
    module.directive('fwAutoComplete', fwAutoComplete);
    ...
    module.directive('fwChart', fwChart);
    ...
    module.directive('fwDatePicker', fwDatePicker);
    ...
    module.directive('fwDynamic', fwDynamic);
    ...
    module.directive('fwInputDetail', fwInputDetail);
    ...
    module.directive('fwInput', fwInput);
    ...
    module.directive('fwTags', fwTags);
    fwTags.$inject = [];
    function fwTags() {
        return {
            restrict: 'E',
    ...
    module.directive('fwUpload', fwUpload);
    ...
    module.filter('fwAgeMonth', fwAgeMonth);
    /**
